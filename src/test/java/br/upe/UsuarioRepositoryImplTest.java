...
//    private static final String TEST_CSV_PATH = "src/test/resources/data/usuarios_test.csv";
//
//    @BeforeEach
//    void setUp() throws IOException {
//        Files.createDirectories(Paths.get("src/test/resources/data"));
//        Files.deleteIfExists(Paths.get(TEST_CSV_PATH));
//        repository = new UsuarioRepositoryImpl(TEST_CSV_PATH);
//    }
//
//    @AfterEach
...
//        Usuario usuario = new Usuario(999, "Nome", "email@test.com", "senha", TipoUsuario.COMUM);
...
//        repository.salvar(usuario);
//
//        IUsuarioRepository novoRepository = new UsuarioRepositoryImpl(TEST_CSV_PATH);
