...
class UsuarioIntegrationTest {
    ...
    @Test
    @Order(1)
    @DisplayName("Integração: Deve cadastrar usuário e persistir no banco")
    void testCadastrarUsuarioCompleto() {
        ...
        Optional<Usuario> usuarioBuscado = usuarioDAO.buscarPorId(usuarioCadastrado.getId());
    ...
    void testFluxoPromocaoUsuario() {
        ...
        Optional<Usuario> usuarioRecarregado = usuarioDAO.buscarPorId(usuario.getId());
